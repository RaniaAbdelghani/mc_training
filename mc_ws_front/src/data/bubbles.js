export const bubbles12 = (propositions) => ({
  1: {
    title: "1- Le contrôleur identifie l'incertitude qu'on veut chercher",
    content: [
      {
        kind: 'text',
        content: "Je suis le contrôleur, mon rôle est de t'aider à utiliser ta métacognition pour décider quelle(s) nouvelle(s) information(s) es utile pour toi à apprendre."
      },
      {
        kind: 'text',
        content: "Pour cela, je te conseille de commencer par bien lire/écouter le texte et essayer de faire le lien avec tes anciennes connaissances. Y a t-il une partie ou une phrase qui n'est pas très claire pour toi et qui te rend curieux(se)?"
      },
      {
        kind: 'text',
        content: "Tiens, je te donne des exemples de ce que, moi, j'ai identifié comme phrases que je ne comprends pas très bien et qui me rendent curieux: "
      },
      {
        kind: 'list',
      ...
      {
        kind: 'text',
        content: "Tu peux choisir celle qui t'intringue le plus en l'écrivant dans l'encadré, ou écrire une autre de ton propre choix. Tu vas ensuite essayer de découvrir cette information avec nos autres amis métacognitifs."
      }
 
    ]
  },
  2: {
    title: '2- Le détéctive pense aux réponses possibles à nos incertitudes',
    content: [
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: "Pour être un bon détective de ton apprentissage, il faut d'abord penser aux réponses possibles qui peuvent résoudre l'incertitude que tu a identifiée avec mon ami le contrôleur. Cela est un bon exercice pour ta mémoire."
      },
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: "Tu peux choisir une proposition de cette liste ou écrire ta propre hypothèse. Ton hypothèse doit être en relation avec ce que t'as écrit dans la première étape."
      }
      ,
  ...
  3: {
    title: "3- L'explorateur cherche les réponses à nos incertitudes",
    content: [
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: "Choisis la question qui est en relation avec l'information que tu cherches et que tu a décrit dans les deux étapes précédentes et écris-la dans l'encadré. Tu peux aussi formuler ta propre question si tu veux."
      },
      ,
  ...
  4: {
    title: "4- Le deuxième contrôleur vérifie si on a bien trouvé la réponse qu'on cherchait",
    content: [
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: `Pour cela, voici trois informations diffèrentes diffèrentes. Est-ce que tu penses que la réponse que tu cherchais est dans cette liste ?`
      },
      {
        kind: 'text',
        content: `Si tu trouves une information qui répond à ta question, écris-là dans l'encadré. Si non, tu peux écrire "Je n'ai pas pu trouver la réponse à ma question".`
      },
      {
        kind: 'list',
...
export const bubbles3 = (propositions) => ({
  1: {
    ...
    content: [
      {
        kind: 'text',
        content: "Maintenant, tu vas essayer de faire ce cyle de métacognition sans nos propositions. Mais on va toujours te rappeler nos missions et nos rôles pour t'aider. Si tu te retrouves bloqué, tu peux demander notre aide pour te donner des propositions. "
      },
      {
        kind: 'text',
        content: "Premièrement, lis/écoute bien le texte et essaie de trouver des liens avec tes anciennes connaissances. Y a t-il une partie pas très claire qui te rend curieux(se) et que tu veux explorer plus?"
      },
      {
        kind: 'text',
        content: "Cela peut être, par exemple, une information qui te surprend ou une nouvelle information que tu lis pour la première fois et que tu as envie de découvrir."
      },
      {
        kind: 'text',
        content: "Prend ton temps et écris les mots ou les phrases du texte que tu veux découvrir plus dans l'encadré."
      },
      {
        kind: 'help',
  ...
  3: {
    ...
    content: [
      {
        kind: 'text',
        content: "Aah, nos amis étaient utiles, n'est ce pas? Maintenant que tu as tes incertitudes et tes hypothèses, tu vas pouvoir te concentrer sur comment chercher ta réponse, tu es un.e petit.e explorateur.ice, comme moi! "
      },
      {
        kind: 'text',
  ...
  4: {
    title: "4- Le deuxième contrôleur vérifie si on a bien trouvé toutes les reponses qu'on cherchait",
    content: [
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: `Pour cela, je te propose cette liste avec des informations qui peuvent contenir des réponses à ta question.`
      },
      {
        kind: 'list',
        items: propositions[3]
...
export const bubbles48 = (propositions) => ({
  1: {
    ...
    content: [
      ...
      {
        kind: 'text',
        content: "Cela peut être, par exemple, une information qui t'as surprise et que tu veux investiguer. Ou aussi une nouvelle information que tu lis pour la première fois et que tu veux découvrir plus."
      },
      {
        kind: 'text',
        content: "Prend ton temps et écris les phrases qui réveillent ta curiosité dans l'encadré"
      },
      {
        kind: 'help',
        content: propositions[0]
  ...
  3: {
    ...
    content: [
      {
        kind: 'text',
        content: "Aah, nos amis étaient utiles, n'est ce pas? Tu va maintenant pouvoir te concentrer sur comment chercher ta réponse, tu es un.e petit.e explorateur.ice, comme moi! "
      },
      {
        kind: 'text',
  ...
  4: {
    title: "4- Le deuxième contrôleur vérifie si on a a bien trouvé toutes les reponses qu'on cherchait",
    content: [
      {
        kind: 'text',
      ...
      {
        kind: 'text',
        content: `Pour cela, je vais te proposer des informations qui peuvent contenir la réponse à ta question. À toi donc de me dire si tu trouves bien ta réponse dans cette liste ou pas.`
      },
      {
        kind: 'list',
        items: propositions[3]
